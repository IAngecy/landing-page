...
const InfiniteMenu: FC<InfiniteMenuProps> = ({ items = [] }) => {
  ...
  const handleButtonClick = () => {
    ...
    if (activeItem.link.startsWith("http")) {
      ...
      // Internal route handling - implementar navegação conforme necessário
      // Exemplo: router.push(activeItem.link) se usando Next.js router
    }
  };
  ...
  return (
    <div className="relative w-full h-full">
      <canvas
        ...
        aria-label="Menu interativo de posts"
        role="application"
      />
      ...
      {activeItem && (
        ...
        `}
          ...
          <button
            ...
            type="button"
            aria-label={`Ver mais sobre ${activeItem.title}`}
            className={`
          absolute
          left-1/2
          z-10
